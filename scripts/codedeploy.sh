...
REGION="eu-west-1"
PACKAGE_NAME="jumpui_${CIRCLE_BUILD_NUM}.tar.gz"
APPLICATION_NAME="odysseus-jump-ui"
DEPLOYMENT_GROUP="odysseus-jump-ui-dev"

echo "Creating package ${PACKAGE_NAME}"
cp appspec.yml dist/ && \
	cd dist && \
	tar czf ${PACKAGE_NAME} odysseus-jump-ui appspec.yml
